...
- Name: wikiblank.spec.ts >> 7. Caricamento della schermata Fase di Gioco e statistiche
- Location: tests\wikiblank.spec.ts:75:5
...
Call log:
  - waiting for locator('.game-stats') to be visible
